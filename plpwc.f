...
c *********************************************************************
c
      call plpwc(cc,deps,sigold,toli,epn,strss,neps)
c
c *********************************************************************
c
c
...
c *********************************************************************
c
       subroutine plpwc(cc,deps,sigold,toli,epn,strss,neps)
c
c *********************************************************************
...
c
c*********************************************************************
       subroutine   hardfunc(ep,cyst,plspe)
c
c
       REAL :: g,etan
